...
def run_style_transfer(content_path, style_path, epochs=500, content_weight=1e3, style_weight=1e1):
    ...
    for i in range(epochs):
        ...
        if i % 25 == 0:
            ...
            #name = r'folder/' + str(image_no) + '.jpg'
            m.save("stylised_image", 'JPEG')
            image_no += 1
            # m = m.save(r"C:\Users\ibrah\Desktop\sync\Medium\Neural Style Transfer\Gifs/geeks.jpg")
